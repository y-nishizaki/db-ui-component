...
class TestChartComponentUncovered:
    ...
    def test_unsupported_chart_type(self):
        ...
        component = ChartComponent(
            data=self.df, chart_type="unsupported", x_column="x", y_column="y"
        )
    ...
    def test_update_data(self):
        ...
        new_df = pd.DataFrame(
            {"x": [6, 7, 8], "y": [35, 40, 45], "category": ["C", "C", "C"]}
        )
    ...
    def test_heatmap_with_pivot_data(self):
        ...
        component = ChartComponent(
            data=heatmap_df, chart_type="heatmap", x_column="col", y_column="value"
        )
    ...
    def test_pie_chart_with_names_and_values(self):
        """円グラフの名前と値のテスト"""
        pie_df = pd.DataFrame({"category": ["A", "B", "C"], "value": [30, 40, 30]})

        component = ChartComponent(
            data=pie_df, chart_type="pie", x_column="category", y_column="value"
        )
    ...
    def test_scatter_chart(self):
        ...
        scatter_df = pd.DataFrame(
            {"x": [1, 2, 3, 4, 5], "y": [2, 4, 1, 5, 3], "size": [10, 20, 15, 25, 30]}
        )

        component = ChartComponent(
            data=scatter_df, chart_type="scatter", x_column="x", y_column="y"
        )
    ...
    def test_none_title(self):
        """Noneのタイトルのテスト"""
        component = ChartComponent(
            data=self.df, chart_type="line", x_column="x", y_column="y", title=None
        )
    ...
    def test_custom_height(self):
        """カスタム高さのテスト"""
        component = ChartComponent(
            data=self.df, chart_type="line", x_column="x", y_column="y", height=600
        )
