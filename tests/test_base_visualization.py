...
class TestBaseVisualizationComponent:
    ...
    def setup_method(self):
        """テスト前のセットアップ"""
        self.component = BaseVisualizationComponent(title="テストチャート", height=600)
    ...
    def test_add_axis_titles_both(self):
        """軸タイトル追加テスト（両方）"""
        layout = {}
        result = self.component._add_axis_titles(layout, x_title="X軸", y_title="Y軸")
    ...
    def test_add_axis_titles_x_only(self):
        """軸タイトル追加テスト（X軸のみ）"""
        layout = {}
        result = self.component._add_axis_titles(layout, x_title="X軸")
    ...
    def test_add_axis_titles_y_only(self):
        """軸タイトル追加テスト（Y軸のみ）"""
        layout = {}
        result = self.component._add_axis_titles(layout, y_title="Y軸")
...
class TestConcreteVisualizationComponent:
    ...
    def test_generate_html_template_with_axis_titles(self):
        ...
        layout_with_axes = self.component._add_axis_titles(
            layout, x_title="X軸タイトル", y_title="Y軸タイトル"
        )
