...
class TestDashboardUncovered:
    ...
    def test_multiple_components(self):
        ...
        dashboard.add_component(component1, position=(0, 0), size=(1, 1), component_id="comp1")
        dashboard.add_component(component2, position=(0, 1), size=(1, 1), component_id="comp2")
