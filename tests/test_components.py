...
class TestChartComponent:
    ...
    def test_chart_component_render(self):
        ...
        chart = ChartComponent(
            data=self.sample_data, chart_type="line", x_column="date", y_column="value"
        )
...
class TestFilterComponent:
    ...
    def test_filter_component_render(self):
        ...
        filter_comp = FilterComponent(
            filter_type="text", column="name", placeholder="名前で検索..."
        )
    ...
    def test_unsupported_filter_type(self):
        ...
        with pytest.raises(ValueError):
            FilterComponent(filter_type="unsupported", column="category")
...
def test_integration():
    ...
    table = TableComponent(
        data=data, enable_csv_download=True, sortable=True, searchable=True
    )
