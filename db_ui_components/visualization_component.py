...
class SankeyChartComponent(BaseComponent):
    ...
    def render(self, data: pd.DataFrame) -> str:
        ...
        try:
            ...
            # HTMLテンプレートの生成
            html = f"""
            <div id="sankey-chart-{self.component_id}" style="width: 100%; height: {self.height}px;"></div>
            <script>
...
class HeatmapComponent(BaseComponent):
    ...
    def render(self, data: pd.DataFrame) -> str:
        ...
        try:
            ...
            # HTMLテンプレートの生成
            html = f"""
            <div id="heatmap-{self.component_id}" style="width: 100%; height: {self.height}px;"></div>
            <script>
...
class NetworkGraphComponent(BaseComponent):
    ...
    def render(self, data: pd.DataFrame) -> str:
        ...
        try:
            ...
            # HTMLテンプレートの生成
            html = f"""
            <div id="network-graph-{self.component_id}" style="width: 100%; height: {self.height}px;"></div>
            <script>
...
class TreemapComponent(BaseComponent):
    ...
    def render(self, data: pd.DataFrame) -> str:
        ...
        try:
            ...
            # HTMLテンプレートの生成
            html = f"""
            <div id="treemap-{self.component_id}" style="width: 100%; height: {self.height}px;"></div>
            <script>
...
class BubbleChartComponent(BaseComponent):
    ...
    def render(self, data: pd.DataFrame) -> str:
        ...
        try:
            ...
            # HTMLテンプレートの生成
            html = f"""
            <div id="bubble-chart-{self.component_id}" style="width: 100%; height: {self.height}px;"></div>
            <script>
