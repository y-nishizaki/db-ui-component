    ...
    def get_container_start_html(self) -> str:
        ...
        if self.layout_type == "grid":
            ...
            <div class="dashboard-container" style="display: grid;
                 grid-template-columns: repeat(12, 1fr); gap: 20px; padding: 20px;">
            """
...
class DashboardRenderer:
    ...
    def render_component(
        self, comp_info: Dict[str, Any], layout_manager: LayoutManager
    ) -> str:
        """コンポーネントをレンダリング"""
...
class Dashboard:
    ...
    def render(self) -> str:
        ...
        for comp_info in self.component_manager.get_all_components():
            html_parts.append(
                self.renderer.render_component(comp_info, self.layout_manager)
            )
